...
-   Each change is a snapshot of the project in its current state.
...
## An aside: The difference between `git` and GitHub
...
-   But GitHub is a helpful tool when you want to:
    ...
    -   maintain two synced copies of code in different locations (for example AVHE and Zest)
...
![](git_lesson_imgs/git_status_command_line.png)
:::

## Ways to interface with `git`

1.  Use a program with a graphical user interface (GUI) such as VSCode, GitHub desktop or Rstudio (many other options exist: [Github GUIs](https://git-scm.com/tools/guis))
...
- In RStudio or VSCode this can be done when you set up a new project;

- To use the command line: `git init`

- You can also "clone" a repository (make a copy of someone else's repository) (`git clone <url>`)
...
![](git_lesson_imgs/Screenshot From 2026-08-27 12-22-57.png)
...
:::{.notes}
Ask the class, why do we have staging first? Why not just commit?
 - testing if code works
 - may have multiple changes across multiple files to bundle together
:::

## Pause to show the workflow 
*in Rstudio or VSCode or [Learn Git Branching](https://learngitbranching.js.org/)*
...
![](git_lesson_imgs/learn_branching_landingpage.png)
...
2.  Make changes, test them, *stage*, and *commit* those changes.
3.  *Merge* the branch with the original copy of your work (the `main` branch)

## Working on branches - Command line version {visibility="hidden"}
...
## Working on branches {visibility="hidden"}
...
# Now you try - Working on branches:
- Go to the following website: 
[https://learngitbranching.js.org/](https://learngitbranching.js.org/)

- Select Lesson 1, Introduction to git commits,
- Work through the level (this tool won't require you to stage files, or add commit messages)


## Merging - Combining work done in parallel

- How do we combine work from two branches?
- Merging is a special kind of commit.
  - "Include work from branch A, and from branch B, and from all of the parents of branch A and B." 
- Merging pulls changes from a distant branch to the branch you are currently sitting on.

##  Pause to demonstrate in sandbox  

## Now you try - Merging branches:
- Go to the following website: 
[https://learngitbranching.js.org/](https://learngitbranching.js.org/)

- Select Lesson 3, Merging in Git
- Work through the level (this tool won't require you to stage files, or add commit messages)
...
- Merge main into your branch *first*
- Resolve any issues
- Test your code
- Merge your branch into main.

## Working on branches: Merging {visibility="hidden"}

### The Scout Pattern Option - this method attributable to think-like-a-git.net
...
## Working on Branches: Rebasing
- Rebasing is a kind of merge
- Rebasing takes a series of commits and copies them from one branch to another branch.
- Advantage: Can make it easier to bring in changes from branches. 
- Also a way to force-fix merge conflicts

## Pause to Rebase in sandbox

## Now you try - Rebasing branches:
- Go to the following website: 
[https://learngitbranching.js.org/](https://learngitbranching.js.org/)

- Select Lesson 4, Intro to Rebasing
- Work through the level (this tool won't require you to stage files, or add commit messages)
